#ifndef __INCLUDE_ROSY_LITE_MESSAGE_H__
#define __INCLUDE_ROSY_LITE_MESSAGE_H__
...
public:
    ...
    lite_message(char type, std::string uuid_from,
    ...
    static std::string pack (char type, std::string uuid_from,
                                        ...
                                        std::string data)
    {
        lite_message msg(type, uuid_from, uuid_recp, data);
        return msg.pack ();
    }

    static lite_message unpack (std::string packed)
    {
        return lite_message
        (
            packed[0],
